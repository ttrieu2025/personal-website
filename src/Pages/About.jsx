  ...
  return (
    <div className="flex flex-col items-start min-h-[80vh] mt-12 px-6 pb-20 gap-12 max-w-5xl mx-auto">
      ...
      <div className="w-full rounded-[2rem] border border-white/10 bg-gradient-to-br from-[#111111] to-[#0a0a0a] p-8 md:p-12 shadow-2xl overflow-hidden relative group">
        ...
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-green-500/10 rounded-full blur-3xl opacity-0" />
          ...
          <div className="flex flex-col gap-6 flex-1">
            ...
            >
              ...
              <h3 className="text-2xl font-extrabold text-gray-100">
                Check out my <span className="text-gray-400">Spotify Playlists </span>
              </h3>
            </div>
