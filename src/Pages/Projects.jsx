      ...
      <div className="bg-[#111111] border border-white/10 shadow-2xl rounded-[2.5rem] p-8 md:p-16 max-w-6xl w-full">
        ...
        <div className="mb-12">
          ...
          >
            ...
            <CardActions sx={{ p: 4, pt: 0 }}>
              <Button 
                href="https://github.com/ELEC-291-2026/Project1.0"
                target="_blank"
                size="medium" 
                sx={{ 
                  color: '#000000', 
          ...
          >
            ...
            <CardActions sx={{ p: 4, pt: 0 }}>
              <Button 
                href="https://github.com/ttrieu2025/lc-meter.git"
                target="_blank"
                size="medium" 
                sx={{ 
                  color: '#000000', 
          ...
          <Card 
            ...
            <CardContent sx={{ p: 4 }}>
              ...
              <Typography variant="h5" sx={{ color: '#ffffff', fontWeight: 800, mb: 2, tracking: '-0.02em' }}>
              Digital <br/> Thermometer
              </Typography>
              <Typography sx={{ color: 'rgba(255,255,255,0.6)', lineHeight: 1.7, fontSize: '0.95rem' }}>
              A digital thermometer system built using an N76E003 microcontroller and LM335 temperature sensor with Python-based stripchart</Typography>
            </CardContent>
            <CardActions sx={{ p: 4, pt: 0 }}>
              <Button 
